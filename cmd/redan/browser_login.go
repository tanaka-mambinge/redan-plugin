...
<style>
:root{color-scheme:light;--red:#9b1c1f;--red-dark:#741417;--ink:#202124;--muted:#667085;--line:#d0d5dd;--canvas:#f7f7f8;--danger:#a12626;--success:#176b38}
*{box-sizing:border-box}body{margin:0;background:var(--canvas);color:var(--ink);font:16px/1.5 system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}.page{min-height:100dvh;display:grid;place-items:center;padding:24px 16px}.shell{width:min(100%,430px)}.brand{display:grid;place-items:center;padding:20px;background:var(--red);border-radius:18px 18px 0 0}.brand img{display:block;width:100px;height:100px;border-radius:16px}.panel{padding:30px;background:#fff;border:1px solid rgba(32,33,36,.1);border-top:0;border-radius:0 0 18px 18px;box-shadow:0 18px 42px rgba(32,33,36,.12)}h1{margin:0;font-size:28px;line-height:1.15}.intro{margin:10px 0 24px;color:var(--muted)}.field{margin-top:17px}label{display:block;margin-bottom:7px;font-size:14px;font-weight:650}input{display:block;width:100%;min-height:48px;padding:11px 13px;border:1px solid var(--line);border-radius:10px;background:#fff;color:var(--ink);font:inherit;font-size:16px}input:focus{border-color:var(--red);outline:2px solid var(--red);outline-offset:-1px}.status{margin:20px 0 0;padding:12px 14px;border-radius:10px;font-size:14px}.status.error{background:#fff1f0;color:var(--danger)}.status.ok{background:#effaf3;color:var(--success)}button{display:block;width:100%;min-height:50px;margin-top:24px;padding:12px 16px;border:0;border-radius:10px;background:var(--red);color:#fff;font:inherit;font-weight:650;cursor:pointer}button:hover{background:var(--red-dark)}.success{text-align:center}.close{margin:12px 0 0;color:var(--muted)}
